...
const translations = {
  ...
  В качестве тематики я выбрал доставку тайской еды, вдохновившись семейным делом — уютным кафе моих родителей. Здесь я применил все свои знания. Благодарю за внимание!`,
...
​Отбасылық кәсібіміз — ата-анамның жайлы дәмханасынан шабыт алып, жоба тақырыбы ретінде тай тағамдарын жеткізу қызметін таңдадым.Бұл жерде бар білімімді қолдандым.
